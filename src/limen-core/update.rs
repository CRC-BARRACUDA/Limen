...
#[doc(hidden)]
pub fn platform_needle() -> (&'static str, &'static str) {
...
#[doc(hidden)]
pub fn select_asset(assets: &[(String, String)]) -> Option<String> {
...
#[doc(hidden)]
pub fn check_update_local(dir: &Path, current: &str) -> Option<UpdateInfo> {
    let (os, arch) = platform_needle();
...
#[doc(hidden)]
pub fn run_ok(cmd: &mut Command) -> bool {
